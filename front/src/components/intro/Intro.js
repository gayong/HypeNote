  ...
  return (
    <div className="overflow-hidden p-0 m-0 w-full text-center items-center justify-center">
      <div className="mx-auto relative w-[100vw]">
        ...
        <Image
          className="animate-spin-slow w-[430px] absolute top-[5.2%] left-[11%] no-drag"
          src={bottom}
          alt="bottom"
        />
        <Image
        ...
        {/* 랜딩페이지 문구 */}
        <div className="load absolute top-[4.8%] left-[58.5%] no-drag" style={{ display: "flex", alignItems: "end" }}>
          <span className="test text-font_primary text-[110px] font-my ml-4 gra" ref={sectionRef[0]}>
            The Best
          </span>
        </div>
        <div className="load absolute top-[6.6%] left-[60%] no-drag" style={{ display: "flex", alignItems: "end" }}>
          <span className="test text-font_primary text-[110px] font-my ml-4 gra">Recipe</span>
        </div>
        <div className="load absolute top-[9.1%] left-[61.5%] no-drag" style={{ display: "flex", alignItems: "end" }}>
          {/* <Image className="w-[14vw] ml-3" src={logokr} alt="logokr" /> */}
          <span className="text-font_primary text-[50px] font-my load no-drag">for</span>
          <Image className="load w-[14vw] ml-3 mb-2 no-drag" src={logokr} alt="logokr" />
        </div>

        {/* 메인화면 로고 아래 로그인/회원가입 */}
        <Link href="/signin">
          <div
            className="load absolute top-[11%] left-[60.5%] no-drag"
            onMouseOver={() => setoutHover(true)}
            onMouseOut={() => setoutHover(false)}>
            <Image className="load w-[100px] no-drag" src={outHover ? signin : signin_hover} alt="signin" />
          </div>
        </Link>
        <Link href="/signup">
          <div
            className="load absolute top-[11%] left-[67.5%] no-drag"
            onMouseOver={() => setinHover(true)}
            onMouseOut={() => setinHover(false)}>
            <Image className=" load w-[110px] no-drag" src={inHover ? signup : signup_hover} alt="signup" />
          </div>
        </Link>

        {/* 첫번째 기능 */}
        <div className="mt-[135px] no-drag">
          <div className="origin-[24%_50%] animate-spin-slow">
            <Image className="ml-[-150px] w-[68vw] no-drag" src={plate} alt="plate" />
          </div>
          <Image
            className="animate-spin-slow w-[430px] absolute top-[26%] left-[11%] no-drag"
            src={bottom}
            alt="bottom"
          />
          <Image
          ...
          />
          <Image
            className="z-10 animate-spin-slow w-[430px] absolute top-[26%] left-[11%] patty except no-drag"
            src={patty}
            alt="patty"
          />
          ...
          <Link href="/signin">
            <div
              ...
              onMouseOver={() => setoutHover(true)}
              onMouseOut={() => setoutHover(false)}>
              <Image className=" w-[150px] no-drag" src={outHover ? signin_hover : signin} alt="signin" />
            </div>
          </Link>
          <Link href="/signup">
            <div
              ...
              onMouseOver={() => setinHover(true)}
              onMouseOut={() => setinHover(false)}>
              <Image className=" w-[150px] no-drag" src={inHover ? signup_hover : signup} alt="signup" />
            </div>
          </Link>
        </div>

        {/* 두번째 기능 */}
        <div className="mt-[110px] no-drag">
          <div className="origin-[24%_50%] animate-spin-slow">
            <Image className="ml-[-150px] w-[68vw] no-drag" src={plate} alt="plate" />
          </div>
          <Image
            className="animate-spin-slow w-[430px] absolute top-[46%] left-[11%] no-drag"
            src={bottom}
            alt="bottom"
          />
          <Image
          ...
          />
          <Image
            className="z-10 animate-spin-slow w-[430px] absolute top-[46%] left-[11%] no-drag"
            src={patty}
            alt="patty"
          />
          <Image
            className="z-20 animate-spin-slow w-[430px] absolute top-[46%] left-[11%] no-drag"
            src={cheese}
            alt="cheese"
          />
          <Image className="top-[48.2%] right-[39%] w-[23vw] absolute no-drag" src={line2} alt="first1" />
        ...
        {/* 세번째 기능 */}
        <div className="mt-[120px] no-drag">
          <div className="origin-[24%_50%] animate-spin-slow">
            <Image className="ml-[-150px] w-[68vw] no-drag" src={plate} alt="plate" />
          </div>
          <Image
            className="animate-spin-slow w-[430px] absolute top-[67%] left-[11%] no-drag"
            src={bottom}
            alt="bottom"
          />
          <Image
          ...
          />
          <Image
            className="z-10 animate-spin-slow w-[430px] absolute top-[67%] left-[11%] no-drag"
            src={patty}
            alt="patty"
          />
          <Image
            className="z-20 animate-spin-slow w-[430px] absolute top-[67%] left-[11%] no-drag"
            src={cheese}
            alt="cheese"
          />
          <Image
            className="z-30 animate-spin-slow w-[430px] absolute top-[67%] left-[11%] no-drag"
            src={top}
            alt="top"
          />
          <Image className="top-[67.4%] right-[39%] w-[23vw] absolute no-drag" src={line3} alt="first1" />
        ...
        {/* 마무리 멘트 */}
        <div className="mt-[120px] -mb-64 p-0 no-drag">
          <div className="origin-[24%_50%] animate-spin-slow">
            <Image className="ml-[-150px] w-[68vw] no-drag" src={plate} alt="plate" />
          </div>
          <Image className="animate-spin-slow w-[470px] absolute top-[87%] left-[8%] no-drag" src={bite} alt="bottom" />
        ...
        <div
          ...
          <Image className="z-50  w-[150px] no-drag" src={hover ? left_hover : left} alt="왼쪽" />
        </div>

        {/* 위아래 화살표 */}
        <Image
          onClick={toPrev}
          className="no-drag w-[4vw] fixed top-[77%] right-[2%] rotate-180 tong hover:-translate-y-1 hover:scale-110 duration-300"
          src={arrow}
          alt="arrow"
        />
        <Image
          onClick={toNext}
          className="no-drag w-[4vw] fixed top-[86%] right-[2%] hover:translate-y-1 tong hover:scale-110 duration-300"
          src={arrow}
          alt="arrow"
        />
      </div>
