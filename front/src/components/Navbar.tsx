...
export default function Navbar() {
  ...
  return (
    <>
      {/* navbar */}
      <div className="scrollbar-hide no-drag z-50 sidebar fixed top-0 bottom-0 lg:left-0 p-2 w-[290px] overflow-y-auto text-center bg-primary text-secondary dark:bg-dark_primary">
